...
@CordaService
class MyService(val services: AppServiceHub) : SingletonSerializeAsToken() {
  companion object {
    val log = loggerFor<MyService>()
  }
  init {
    log.info("Initialising MyService ${services.myInfo.legalIdentities.first().name.organisation}")
  }
}